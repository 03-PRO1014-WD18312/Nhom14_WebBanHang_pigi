        ...
        <div class="container-fluid">
            ...
            <form action="index.php?act=update_lm" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="mt-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="txtTitle" placeholder="Nhập tên loại mì" style="margin-bottom: 10px;" value="<?= $name ?>">
                    <label for="txtTitle " class="form-label" id="lblTitle">Giá</label>
                    <input type="text" class="form-control" name="price" id="txtTitle" placeholder="Nhập tên loại mì" style="margin-bottom: 10px;" value="<?= $price ?>">
